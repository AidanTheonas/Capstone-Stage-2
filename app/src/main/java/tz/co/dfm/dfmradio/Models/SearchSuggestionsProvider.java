...
public class SearchSuggestionsProvider extends SearchRecentSuggestionsProvider {
  public static final String AUTHORITY =
      "tz.co.dfm.dfmradio.content.android.searchSuggestionsProvider";
  ...
  public Cursor query(
    ...
    for (int i = 0; i < defaultCursor.getCount(); i++) {
      ...
      generatedCursor.addRow(
          new Object[] {
            defaultCursor.getInt(defaultCursor.getColumnIndex(SearchManager.SUGGEST_COLUMN_FORMAT)),
            searchResultLeftIcon,
            defaultCursor.getString(
                defaultCursor.getColumnIndex(SearchManager.SUGGEST_COLUMN_TEXT_1)),
            defaultCursor.getString(
                defaultCursor.getColumnIndex(SearchManager.SUGGEST_COLUMN_QUERY)),
