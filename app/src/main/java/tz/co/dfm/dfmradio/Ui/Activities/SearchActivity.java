...
public class SearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, OnEpisodeClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float marginLeft = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,64,getResources().getDisplayMetrics());
        searchAutoComplete.setPadding((int)marginLeft,0,0,0);
        searchAutoComplete.setDropDownAnchor(R.id.search_toolbar);

        ImageView clearSearchView = searchView.findViewById(android.support.v7.appcompat.R.id.search_close_btn);
        ...
        if (savedInstanceState != null) {
            latestEpisodesAdapter = savedInstanceState.getParcelable(ShowEpisodesFragment.SHOWS_ADAPTER_STATE);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String queryString = cursor.getString(cursor.getColumnIndex(SearchManager.SUGGEST_COLUMN_TEXT_1));
