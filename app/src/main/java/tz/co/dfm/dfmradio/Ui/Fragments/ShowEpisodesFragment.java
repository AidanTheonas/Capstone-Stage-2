...
/**
 * Use the {@link ShowEpisodesFragment#newInstance} factory method to create an instance of this
 * fragment.
 */
@SuppressWarnings({"ConstantConditions", "StringBufferReplaceableByString"})
public class ShowEpisodesFragment extends Fragment
    implements OnEpisodeClickListener, SwipeRefreshLayout.OnRefreshListener {
   ...
   * parameters.
   *
   * @param showTitleID represents Show title ID.
   * @return A new instance of fragment ShowEpisodesFragment.
   */
  public static ShowEpisodesFragment newInstance(int showTitleID) {
    ShowEpisodesFragment fragment = new ShowEpisodesFragment();
    Bundle args = new Bundle();
    args.putInt(SHOW_TITLE, showTitleID);
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (getArguments() != null) {
      showTitle = getArguments().getInt(SHOW_TITLE);
    }
  }
  ...
  public View onCreateView(
    ...
    swipeRefreshEpisodes.setColorSchemeColors(
    ...
    int gridLayoutManagerSpanCount =
        getContext().getResources().getInteger(R.integer.shows_grid_layout_span_count);
    RecyclerView.LayoutManager mLayoutManager =
        new GridLayoutManager(getContext(), gridLayoutManagerSpanCount);
    ...
    if (shouldLoadServerData) loadServerData();
    return mainView;
  }
    ...
    JsonArrayRequest jsonArrayRequest =
        new JsonArrayRequest(
            ...
            response -> {
              ...
              for (int i = 0; i < response.length(); i++) {
                try {
                  ...
                  String mediaFileUrl =
                      buildMediaUrl(jsonObject.optString(EPISODE_FILE_URL), mediaType);
            ...
            error -> {
              ...
              errorSnackbar =
                  Snackbar.make(
                          getActivity().findViewById(R.id.cl_main_view),
  ...
  public void onRefresh() {
    if (errorSnackbar != null) {
      if (errorSnackbar.isShown()) errorSnackbar.dismiss();
    }
    swipeRefreshEpisodes.setRefreshing(true);
    loadServerData();
  }
